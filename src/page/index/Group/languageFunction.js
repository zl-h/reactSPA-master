...
export function executeLanguage(data, index, action){
    ...
    return dispatch => {
        if(action.type === LanguageGetDataAction.type){
            //加载用户数据
            console.log("加载用户数据");
            dispatch(commonFetch(url.index_group_getTableData_url,action.requestBody,LanguageGetDataActionLoading,LanguageGetDataActionSuccess,LanguageGetDataActionFailure));
        }
        else if(action.type === LanguagedeleteDataAction.type){
            //加载用户数据
            console.log("删除语言数据");
            dispatch(commonFetch(url.index_group_removeData_url,action.requestBody,LanguagedeleteDataActionLoading,LanguagedeleteDataActionSuccess,LanguagedeleteDataActionFailure));
        }
            ...
            dispatch(commonFetch(url.index_group_editData_url,json,LanguageEditDataActionLoading,LanguageEditDataActionSuccess,LanguageEditDataActionFailure));
        }
            ...
            dispatch(commonFetch(url.index_group_addData_url,json,LanguageAddDataActionLoading,LanguageAddDataActionSuccess,LanguageAddDataActionFailure));
